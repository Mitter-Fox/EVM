...
<body>
        ...
        <div class="adjust-nav">
          <div class="navbar-header"><a class="navbar-brand" href="AdminPortal.jsp">
             ...
             <span class="logout-spn" >
              <a style="color:#fff;" ><br><p><strong><font size ="12"> UPDATE REGISTRATION</font></strong></p>
              </a>  
    ...
    <form name="form1" method="post" action="UpdateRegServ" >
      <div align="center"><br>
        <br><br><br><br>
      </div>
      <p align="center">
      ...
      <p align="center">
        <input type="submit" name="v_button" id="v_button" value="                                    UPDATE                                     ">
      </p>
    </form>
    <br><br><br>
                        <div align="center">
