...
<body>
        ...
        <div class="adjust-nav">
          <div class="navbar-header"><a class="navbar-brand" href="AdminPortal.jsp">
             ...
             <span class="logout-spn" >
              <a style="color:#fff;" ><br><p><strong><font size ="12"> VOTE DETAILS</font></strong></p>
              </a>  
    ...
    <table class="table table-hover" style="background: #F0F0F0" ALIGN="CENTER" >
            
            <tr style="background: appworkspace" ALIGN="CENTER">
                <td>PARTY</td>
                <td>COUNT</td>
                            </tr>
            <%
